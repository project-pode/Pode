import { View, Pressable, Text, Image, ScrollView, Animated, ImageStyle } from "react-native";
        ...
        <View style={mainTheme.blueContainer}>
            ...
            <View style={theme.podeAndLetsCodeButtonContainer}>
                <View style={theme.podeContainer}>
                    <Image source={require("../../../assets/placeHolderPode.png")} style={theme.podeIcon as ImageStyle} />
                </View>
