...
import { View, Text, Image, Pressable, Modal, ScrollView, Animated, ImageStyle } from 'react-native';
 ...
 */
const ProfileView = ({ onLogout }: ProfileViewProps) => {
    ...
    const renderAvatar = (avatarName: string) => {
        ...
        return avatar ? <Image source={avatar.source} style={theme.profileImage as ImageStyle} testID='avatar' /> : null;
    };
                                ...
                                {avatars.map((avatar, index) => (
                                    ...
                                    >
                                        <Image
                                            ...
                                            style={[
                                                theme.avatar as ImageStyle,
                                                selectedAvatar === avatar.name && theme.selectedAvatar as ImageStyle
                                            ]}
                                        />
                                    </Pressable>
                                ))}
